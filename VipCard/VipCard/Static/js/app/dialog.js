(function() {
    ...
    Vue.component("alertDialog", {
        ...
        template: '<div class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="z-index: 2100;"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">{{title}}</h4></div><div class="modal-body">{{body}}</div><div class="modal-footer"><button type="button" class="btn btn-primary" data-dismiss="modal">{{ok}}</button></div></div></div></div>'
    });
...
(function() {
    ...
    Vue.component("confirmDialog", {
        ...
        template: '<div class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="z-index: 2000;"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">{{title}}</h4></div><div class="modal-body">{{body}}</div><div class="modal-footer"><button type="button" class="btn btn-primary" @click="clickYes">{{yes}}</button><button type="button" class="btn btn-primary" @click="clickNo">{{no}}</button></div></div></div></div>'
    });
...
(function() {
    ...
    Vue.component("waitDialog", {
        ...
        template: '<div class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="z-index: 2200;"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">{{title}}</h4></div><div class="modal-body text-center">{{body}}</div></div></div></div>'
    });
...
(function() {
    ...
    Vue.component("customDialog", {
        ...
        template: '<div class="modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" style="z-index: 1900;"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">{{title}}</h4></div><div class="modal-body text-center"></div></div></div></div>'
    });
